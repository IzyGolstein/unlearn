...
- понимаем, что команды для винды или для линукса отличаются, все-таки это разные операционные системы
...
- ориентироваться в структуре директорий (каталогов): где я сейчас нахожусь, как перйти на уровень выше, есть лли подкаталоги 
